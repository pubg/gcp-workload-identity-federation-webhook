				...
				Spec: corev1.PodSpec{
					...
					InitContainers: []corev1.Container{
						decorateDefault(corev1.Container{
							...
							Image:        "busybox:test",
							VolumeMounts: volumeMountsToAddOrReplace(DirectMode),
							Env:          append(envVarsToAddOrReplace(DirectMode), envVarsToAddIfNotPresent(DefaultGCloudRegionDefault, "{PROJECT_NUMBER}")...),
						}),
					},
					Containers: []corev1.Container{decorateDefault(corev1.Container{
						Name:         "ctr",
				...
				Spec: corev1.PodSpec{
					...
					InitContainers: []corev1.Container{
						...
						decorateDefault(corev1.Container{
							...
							Image:        "busybox:test",
							VolumeMounts: volumeMountsToAddOrReplace(GCloudMode),
							Env:          append(envVarsToAddOrReplace(GCloudMode), envVarsToAddIfNotPresent(DefaultGCloudRegionDefault, "{PROJECT_NUMBER}")...),
						}),
					},
					Containers: []corev1.Container{decorateDefault(corev1.Container{
						Name:         "ctr",
